<template>
  <div class="pb-4 flex items-center">
    ...
    <DefaultButton class="ml-2 px-1">+ Add filter</DefaultButton>
...
import IconColumns from '@/components/IconColumns.vue';
...
export default
{
  ...
  emits: ['update:search', 'refresh', 'export'], // export(allColumns)
  data()
  {
    return {
